			...
			<div class="flex-container">
				...
				<div class="container-center">
					<div class="mx-auto mt-5">
						<a href="${root}"> <img src="${root}/resources/img/두줄로고.png"
							style="width: 400px;">
						</a>
					</div>
				...
				<div class="badge text-wrap bg-primary bg-opacity-75 mt-5 pt-3"
					...
					<div class="collapse navbar-collapse" id="navbarColor01">
						<ul class="navbar-nav me-auto navbar-right">
							<li class="nav-item dropdown"><a
								class="nav-link dropdown-toggle docs-creator headMember"
								data-bs-toggle="dropdown" href="#" role="button"
								aria-haspopup="true" aria-expanded="false">Info</a>
								<div class="dropdown-menu">
									<a class="dropdown-item docs-creator headMember"
										href="${root }">Home</a> <a
										class="dropdown-item docs-creator headMember"
										href="${root}/upgrade">보호소 등급신청 방법</a> <a
										class="dropdown-item docs-creator headMember"
										href="${root}/support">유기동물 입양 지원 안내</a> <a
										class="dropdown-item docs-creator headMember"
										href="${root}/question/">1:1 문의하기</a>
								</div></li>
						</ul>
						<ul class="navbar-nav me-auto navbar-center fs-6">
							<li class="nav-item ms-1"><a
								class="nav-link docs-creator headShop" href="${root}/shop/"
								aria-current="page">후원상품🐾</a></li>
							<li class="nav-item ms-5"><a
								class="nav-link docs-creator headDonation"
								href="${root}/donation/">기부🐾</a></li>
							<li class="nav-item ms-5"><a
								class="nav-link docs-creator headAdopt" href="${root}/adopt/">입양공고🐾</a>
							</li>
							<li class="nav-item ms-5"><a
								class="nav-link docs-creator headMybaby" href="${root }/mybaby/">내새끼자랑🐾</a>
							</li>
						</ul>
						<ul class="navbar-nav navbar-left">
							<c:if test="${!login}">
								<li class="nav-item"><a
									class="nav-link docs-creator headMember"
									href="${root}/member/login">LOGIN</a></li>
								<li class="nav-item dropdown"><a
									class="nav-link dropdown-toggle docs-creator headMember"
									data-bs-toggle="dropdown" href="#" role="button"
									aria-haspopup="true" aria-expanded="false">𓃑𓃑𓃑ʕ •ᴥ•ʔ</a>
									<div class="dropdown-menu">
										<a class="dropdown-item docs-creator headMember"
											href="${root}/member/join">회원가입ฅ ̳͒•ˑ̫• ̳͒ฅ♡</a> <a
											class="dropdown-item docs-creator headMember"
											href="${root}/find/findId">아이디 찾기</a> <a
											class="dropdown-item docs-creator headMember"
											href="${root}/find/findPw">비밀번호 찾기</a>
									</div></li>
							</c:if>
							<c:if test="${login}">
								<li class="nav-item"><a
									class="nav-link active docs-creator headMember"
									href="${root}/member/mypage/my_info">MY PAGE</a></li>
								<c:if test="${admin}">
									<li class="nav-item"><a
										class="nav-link active docs-creator headAdmin"
										href="${root}/admin/main">ADMIN</a></li>
								</c:if>
								<li class="nav-item ms-3"><a
									class="nav-link active docs-creator"
