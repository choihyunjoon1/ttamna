...
<jsp:include page="/WEB-INF/views/template/header.jsp"></jsp:include>
  ...
  <form method="post">
  		...
  		<div class="row">
  			<label>상품명 : </label>
  			<input type="text" name="shopGoods" class="form-input form-inline">
  		</div>
  		<div class="row">
  			<label>판매가 : </label>
  			<input type="number" name="shopPrice" class="form-input form-inline">
  		</div>
  		<div class="row">
  			<label>수량 : </label>
  			<input type="number" name="shopCount" class="form-input form-inline">
  		</div>
  		<div class="row">
