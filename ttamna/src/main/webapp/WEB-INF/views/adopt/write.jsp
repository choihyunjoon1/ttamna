...
<div class="container-700 container-center">
	...
	<form method=post>
	<input type="hidden" name="adoptWriter" value="${uid}">
		...
		<div class="input-group mt-3 mb-3">
		  ...
		  <input type="text" name="adoptType" class="form-control" required placeholder="예시- 개/믹스 고양이/코숏 " aria-describedby="basic-addon4">
		</div>
		<div class="input-group mb-3">
		...
		<div class="input-group mb-3">
		  ...
		  <textarea name="adoptContent" class="form-control" aria-label="With textarea"></textarea>
		</div>
