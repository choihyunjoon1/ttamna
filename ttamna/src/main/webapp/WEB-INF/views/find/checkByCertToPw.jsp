...
<div class="container-500 bg-white container-center container-height-300" >
	...
	<form action="checkByCertToPw" method="post" id="login-form">
		<div class="align-self-center">인증번호를 전송하였습니다.</div>
		<div class="align-self-center">이메일을 확인하고 인증번호를 입력해주세요</div>
