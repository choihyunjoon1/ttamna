...
<div class="col-3">
	...
	<!-- 클릭할 때 해당 메뉴 class에 active 붙이기 -->
		<a href = "${root }/admin/member" class="list-group-item list-group-item-action myInfo" >내 정보</a>
		<a href = "${root }/admin/mypage/edit" class="list-group-item list-group-item-action edit">정보 수정</a>
